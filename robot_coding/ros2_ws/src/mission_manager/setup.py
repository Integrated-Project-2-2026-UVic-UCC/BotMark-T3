...
setup(
    ...
    description="This node manages autonomous navigation by sequentially sending waypoints " \
    "to the controller node via a ROS 2 Action Server. " \
    "It monitors state changes such as emergency stops " \
    "to pause or abort missions accordingly.",
